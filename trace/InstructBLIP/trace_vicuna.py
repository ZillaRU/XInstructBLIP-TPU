...
"""
Usage: python trace_vicuna.py --model_path /workspace/vicuna-7b-1.1 --seq_length 512
"""

parser = argparse.ArgumentParser(description='export onnx.')
parser.add_argument('--model_path', type=str, default='/workspace/vicuna-7b-1.1', help='path to the torch model.')
...
llm_tokenizer = LlamaTokenizer.from_pretrained(model_path, use_fast=False, truncation_side="left")
